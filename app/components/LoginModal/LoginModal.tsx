            ...
            <div className="relative rounded-lg bg-white shadow dark:bg-gray-700">
              ...
              <div className=" px-6 py-6 lg:px-8">
                ...
                <div className="my-4 flex items-center gap-1 text-xs dark:text-slate-100">
                  <div className=" h-[1px] flex-1 bg-slate-300 dark:bg-slate-500"></div>
                  or
                  <div className=" h-[1px] flex-1 bg-slate-300 dark:bg-slate-500"></div>
                </div>
                {/* social login */}
                <div className="flex flex-col gap-2">
                  <button
                    ...
                    className="mb-2 inline-flex items-center justify-center rounded-lg bg-[#24292F] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#24292F]/90 focus:outline-none focus:ring-4 focus:ring-[#24292F]/50 dark:hover:bg-[#050708]/30 dark:focus:ring-gray-500"
                  >
                    <svg
                  ...
                  <button
                    ...
                    className="dark:focus:ring-[#4285F4]/55 mb-2 inline-flex items-center justify-center rounded-lg bg-[#4285F4] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#4285F4]/90 focus:outline-none focus:ring-4 focus:ring-[#4285F4]/50"
                  >
                    <svg
                      className="-ml-1 mr-2 h-4 w-4"
                      aria-hidden="true"
